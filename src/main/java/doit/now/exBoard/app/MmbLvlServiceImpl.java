...
@Service("MmbLvlService")
public class MmbLvlServiceImpl implements MmbLvlService{
    @Autowired
    MmbLvlMapper mmbLvlMapper;
    ...
    public Map<String, Object> getBoardList(HashMap<String, Object> body) throws Exception {
        ...
        List<Map<String, Object>> list = mmbLvlMapper.selectList(body);
    ...
    public Map<String, Object> insertBoard(HashMap<String, Object> body) {
        Map<String, Object> resultBody = new HashMap<String, Object>();
        int result = mmbLvlMapper.insertBoard(body);
