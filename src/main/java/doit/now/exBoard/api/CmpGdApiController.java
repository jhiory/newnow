...
import doit.now.exBoard.app.CmpGdService;
...
@RestController("CmpGdApiController")
@Api(value = "CmpGdApiController", description = "테스트 컨트롤러")
public class CmpGdApiController {
    @Autowired
    CmpGdService cmpGdService;

    @ApiOperation(value = "데이터 조회", notes = "마스터 데이터 조회")
    @Transactional(value = "transactionManager",readOnly = true)
    @PostMapping("/api/cmpGd/getBoardList")
