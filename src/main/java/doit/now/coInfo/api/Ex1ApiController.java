package doit.now.coInfo.api;

import doit.now.coInfo.app.Ex1Service;
...
@RestController("ex1ApiController")
@Api(value = "ex1ApiController", description = "테스트 컨트롤러")
public class Ex1ApiController {
    @Autowired
    Ex1Service ex1Service;

    @ApiOperation(value = "데이터 등록", notes = "마스터 데이터 등록")
    @Transactional(value = "transactionManager")
    @PostMapping("/api/ex1/insertBoard")
