 ...
 ********************************************************************************/
function domReady(){
    opGdEvn.initPage();	//페이지 초기화 처리
    opGdEvn.defineEvent();	//이벤트 정의
    console.log(12124);
};
...
var opGdEvn = {
    ...
    defineEvent:function(){
        ...
        $("#selectRtn").click(function(e){opGdEvn.selectRtn1();});	//조회버튼
...
//		-------------------------------------------------------------------------------
    ...
    getList:function () {
        ...
        //파라메터정의
        var objJsonParams = {};
        objJsonParams.Service= "opGdEvn/getBoardList";
        ...
        // 그리드 그리는 함수 호출
        opGdEvn.makeGrid(objJsonReturn.JsonObj.result);
        //결과값 반환
    ...
    // return;
        ...
        //파라메터정의
        var objJsonParams = {};
        objJsonParams.Service= "opGdEvn/insertBoard";
