 ...
 ********************************************************************************/
function domReady(){
    bsnSlfEvn.initPage();	//페이지 초기화 처리
    bsnSlfEvn.defineEvent();	//이벤트 정의
    console.log(12124);
};
...
var bsnSlfEvn = {
    ...
    defineEvent:function(){
        ...
        $("#selectRtn").click(function(e){bsnSlfEvn.selectRtn1();});	//조회버튼
...
//		-------------------------------------------------------------------------------
    ...
    getList:function () {
        ...
        //파라메터정의
        var objJsonParams = {};
        objJsonParams.Service= "bsnSlfEvn/getBoardList";
        ...
        // 그리드 그리는 함수 호출
        bsnSlfEvn.makeGrid(objJsonReturn.JsonObj.result);
        //결과값 반환
    ...
    // return;
        ...
        //파라메터정의
        var objJsonParams = {};
        objJsonParams.Service= "bsnSlfEvn/insertBoard";
        objJsonParams.name= $("#name").val();
        objJsonParams.title= $("#title").val();
