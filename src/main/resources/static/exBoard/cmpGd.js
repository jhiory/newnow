 ...
 ********************************************************************************/
function domReady(){
    cmpGd.initPage();	//페이지 초기화 처리
    cmpGd.defineEvent();	//이벤트 정의
    //console.log(12124);
};
...
var cmpGd = {
    ...
    defineEvent:function(){
       // console.log(1212);
        ...
        $("#selectRtn").click(function(e){cmpGd.selectRtn1();});	//조회버튼
...
//		-------------------------------------------------------------------------------
    ...
    getList:function () {
      // console.log(1212);
        ...
        //파라메터정의
        var objJsonParams = {};
        objJsonParams.Service= "cmpGd/getBoardList";
       ...
       // console.log("selectRtn : ",objJsonParams);
        ...
        // 그리드 그리는 함수 호출
        cmpGd.makeGrid(objJsonReturn.JsonObj.result);
        //결과값 반환
    ...
    makeGrid:function (data) {
        if(data.length > 0){
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                //     + "<td>"+element.date+"</td>"
                //     + "</tr>";
                var text=element.bsnex;
                imgList = "<div class='blog-item'>"
                        +"<div class='bi-pic'><img src='common/img/blog/"+element.imgnm+"' alt=''></div>"
                        +"<div class='bi-text'>"
                        +"<h5><a href='./blog-details.html'>"+element.bsnnm+"</a></h5>"
                        +"<ul>"
                        +"<li>by <span>"+element.cnt+"</span></li>"
                        +"<li>"+element.rgsdt+"</li>"
                        +"</ul>"
